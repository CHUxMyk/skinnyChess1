...
import com.skinnyChess.logic.IPlayerHandler;
import com.skinnyChess.logic.Move;
import com.skinnyChess.logic.MoveValidator;
...
public class ChessGui extends JPanel implements IPlayerHandler{
	...
	private static final int BOARD_START_X = 36;
	private static final int BOARD_START_Y = 36;

	private static final int SQUARE_WIDTH = 72;
	private static final int SQUARE_HEIGHT = 72;

	private static final int PIECE_WIDTH = 72;
	private static final int PIECE_HEIGHT = 72;
	...
	public ChessGui(ChessGame chessGame) {
		...
		// background
		URL urlBackgroundImg = getClass().getResource("/com/skinnyChess/gui/img/chessBoard1.png");
		...
		lblGameState.setBounds(800, 30, 80, 30);
	...
	private Image getImageForPiece(int color, int type) {
		...
		filename += (color == Piece.COLOR_WHITE ? "White" : "Black");
		switch (type) {
		...
		URL urlPieceImg = getClass().getResource("/com/skinnyChess/gui/img/" + filename);
